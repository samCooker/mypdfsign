...
public class PdfiumCore {
    private static final String TAG = com.shockwave.pdfium.PdfiumCore.class.getName();
     ...
     * Page must be opened before rendering.
     * <p>
     * For more info see {@link com.shockwave.pdfium.PdfiumCore#renderPageBitmap(PdfDocument, Bitmap, int, int, int, int, int)}
     */
    public void renderPageBitmap(PdfDocument doc, Bitmap bitmap, int pageIndex,
                                 int startX, int startY, int drawSizeX, int drawSizeY,
                                 boolean renderAnnot) {
    ...
    /**
     * @return mapped coordinates
     * @see com.shockwave.pdfium.PdfiumCore#mapPageCoordsToDevice(PdfDocument, int, int, int, int, int, int, double, double)
     */
